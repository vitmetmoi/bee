<div class="p-6 bg-white rounded-lg shadow-sm">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Bài viết đã lên lịch</h2>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button wire:click="cancelScheduledPost({{ $post->id }})" 
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Không có bài viết nào đã lên lịch</h3>
            <p class="mt-1 text-sm text-gray-500">Tất cả bài viết đã được xuất bản hoặc chưa có lịch xuất bản.</p>
        </div>
    @endif
</div> 